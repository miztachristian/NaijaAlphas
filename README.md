...
**NaijaAlphas closes that gap.** It's a complete research desk in software: it ingests everything the market publishes, scores every listed name on eight independent dimensions, fuses them into a single explainable conviction number, sizes a portfolio around it — and lands the whole thing in your Telegram before the market opens.

## ⚡ What you get

| | |
|---|---|
| 📥 **Total market ingestion** | TradingView fundamentals & scanner, AssessWorth, NGX corporate disclosures, annual reports, Proshare research, earnings forecasts, news, and Nigerian macro — pulled automatically. `ingest/` |
